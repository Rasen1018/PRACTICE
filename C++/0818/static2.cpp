...
public:
	...
	Chulsoo(int age) : age(age) {
		...
		cout << "Chulsoo::Chulsoo(age) 생성자로 만들어지는 " << chulsooPrivateCounter <<
			"(Private) 번째 객체 생성 완료" << endl;
		cout << "Chulsoo::Chulsoo(age) 생성자로 만들어지는 " << chulsooProtectedCounter <<
			"(Protected) 번째 객체 생성 완료" << endl;
		cout << "Chulsoo::Chulsoo(age) 생성자로 만들어지는 " << chulsooPublicCounter <<
			"(Public) 번째 객체 생성 완료" << endl;
	}
};
...
public:
	Younghee(int age) : age(age) {
		...
		cout << "Younghee::Younghee(age 생성자로 만들어지는 " << Chulsoo::chulsooPublicCounter <<
			"번째 객체 생성 완료" << endl;
	}
};
